...
c = 0.5
trajectory = [
    CompressedStart(1.0, 1.0, 1.0, 1.0),
    CompressedSegment(5.0, [1.0, 0.0, 0.5], [1.0, 0.0, 0.5], [], []),
    CompressedSegment(5.0, [0.5, 0.0, 1.0], [0.5, 0.0, 1.5], [], []),
    CompressedSegment(5.0, [1.0, 0.0, 1.5], [1.5, 0.0, 1.0], [], []),
    CompressedSegment(5.0, [1.5, 0.0, 1.0], [1.0, 0.0, 1.5], [], []),
]
...
def run_sequence(cf, trajectory_id, duration):
    ...
    time.sleep(3.0)
    relative = True
    commander.go_to(1.0, 1.0, 1.5, 90, 5.0, relative=False)
    time.sleep(duration)
    commander.go_to(2.0, 0.5, 0.5, 270, 5.0, relative=False)
    time.sleep(duration)
    commander.go_to(2.0, 2.5, 1.5, 0, 5.0, relative=False)
    time.sleep(duration)
    commander.go_to(0.5, 2.5, 1.5, 0, 5.0, relative=False)
    time.sleep(duration)

...
data = pd.read_csv('traject14_log6C_Robust_Mellinger_cf8.csv', header=0, delimiter=',', skiprows=0, usecols=[1, 2, 3])
...
Ref_data = pd.read_csv('timed_waypoints_yaw14.csv', header=0, delimiter=',', skiprows=0, usecols=[1, 2, 3])

...
data = pd.read_csv('OOI_traject14_log4_Robust_Mellinger_cf8.csv', header=0, delimiter=',', skiprows=0, usecols=[1, 2, 3])
...
data2 = pd.read_csv('timed_waypoints_yaw14.csv', header=0, delimiter=',', skiprows=0, usecols=[1, 2, 3])

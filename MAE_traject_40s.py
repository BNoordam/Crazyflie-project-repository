...
data_pre = pd.read_csv('traject12_log2_Robust_PID_cf2.csv', header=0, delimiter=',', skiprows=0, usecols=[1, 2, 3])
data = data_pre.iloc[35:436, :]
...
Ref_data = pd.read_csv('timed_waypoints_yaw12.csv', header=0, delimiter=',', skiprows=0, usecols=[1, 2, 3])
